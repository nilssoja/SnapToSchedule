...
public class MainActivity extends Activity {
	...
	//Add to calendar method that will be called after the OCR string is parsed and used to create a ScheduleItem
	public void addToCalendar(ScheduleItem SI){
		
				//Set beggining and end time for schedule item based on paramters from ScheduleItem SI
				...
				//Pass information to calendar using an intent.  The information passed is from paramaters of ScheduleItem SI
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK
			...
			// Show toast message containing recognized text
